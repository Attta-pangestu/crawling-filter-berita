...
def generate_array_search():
    ...
    for key, search_prop in search_engine_props.items():
        search_link = f'{BING_SEARCH_URL}{keyword}&filters=ex1%3a"ez5_{convert_date_filter_bing(date_start)}_{convert_date_filter_bing(date_end)}"'
